...
var dashboard = {
    ...
    init : function(){   
        if($("#typeChk").val() ==null || $("#typeChk").val() ==''){
            //window.location.href = 'http://sms.lgensol.com:8081/browserWarn/';
                    ...
                    if(verDatas){
                        for(let j=0; j<verDatas.length; j++){
                            ...
                            verList += '<tr>' +
                                    ...
                                    '    <td> ' +
                                    (verDatas[j].dwn_pgm_ver === null ? '' : ((verDatas[j].dwn_new_ver === verDatas[j].dwn_pgm_ver) ? verDatas[j].dwn_pgm_ver : '<span class="txt-point">'+ verDatas[j].dwn_pgm_ver + '</span>' )) +                                       
                                    '    </td> ' +
